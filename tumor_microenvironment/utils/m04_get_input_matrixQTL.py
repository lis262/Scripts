...
if purity == 'yes':
    ...
    covari_fn = path + '/f02_covariates_peer.tsv'
...
analyze_samples = sorted(list(set(cyto_samples).intersection(covari_samples)))
...
# # ------------------------ plot qq plot --------------------------------
# os.chdir(qtl_path + '/' + tumor_prefix)
# qq_fn = '~/Code/Scripts/tumor_microenvironment/utils/m11_qqplot.R'
# cmd = 'Rscript {qq} {i} {o}'.format(qq=qq_fn,i=qtl_fn+'.gz',o=qtl_fn[:-3]+'png')
# os.system(cmd)